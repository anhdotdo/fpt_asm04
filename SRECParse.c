...
static FILE* fPtr = NULL;                   // static gloval variables
...
/*
input: line of srec file #S0
output: state(true/false - details)
*/
SREC_Status_Type SREC_ReadLine(uint8_t *is_valid_format){
    *is_valid_format = 0;                                   // default value: invalid format
                    ...
                    if(status == SREC_LINE_TRUE){
                        ...
                        for(idx = 0; idx < srec_data_bytes; idx++){
                            ...
                            if(status == SREC_ERROR_FORMAT){
                                break;                      // stop getting data-> default data value: 0x00
                            }
                        }
                        ...
                        if(status == SREC_LINE_TRUE){
                            ...
                            // =>calcular & check sum
                            if(status == SREC_LINE_TRUE){
                                *is_valid_format = 1;                                // valid format
